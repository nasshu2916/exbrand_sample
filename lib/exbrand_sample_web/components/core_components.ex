defmodule ExbrandSampleWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div class="mb-4">
      <label for={@id}>
        <span :if={@label} class="mb-1 block">{@label}</span>
        <select
          id={@id}
          name={@name}
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ExbrandSampleWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ExbrandSampleWeb.Gettext, "errors", msg, opts)
    # end
